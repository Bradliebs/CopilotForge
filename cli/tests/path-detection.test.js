...
// ─────────────────────────────────────────────────────────────────────────────
// 3. Version stamp — all paths carry v1.7.0
// ─────────────────────────────────────────────────────────────────────────────

describe('getPlatformForge - version stamp', () => {
  for (const letter of PLATFORM_PATHS) {
    it(`Path ${letter} contains <!-- copilotforge: v1.7.0 -->`, () => {
      assert.ok(
        getPlatformForge(letter).includes('copilotforge: v1.7.0'),
        `Path ${letter} template should carry version stamp v1.7.0`
      );
    });
  }
