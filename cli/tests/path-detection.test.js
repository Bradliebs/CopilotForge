...
// ─────────────────────────────────────────────────────────────────────────────
// 3. Version stamp — all paths carry v2.2.0
// ─────────────────────────────────────────────────────────────────────────────

describe('getPlatformForge - version stamp', () => {
  for (const letter of PLATFORM_PATHS) {
    it(`Path ${letter} contains <!-- copilotforge: v2.2.0 -->`, () => {
      assert.ok(
        getPlatformForge(letter).includes('copilotforge: v2.2.0'),
        `Path ${letter} template should carry version stamp v2.2.0`
      );
    });
  }
