...
- **Python recipes were intentionally removed** — keep TypeScript only in templates
...
All 161 tests must pass before any change is complete. If a behaviour change breaks tests,
...
- Do not add Python duplicates back to cookbook templates
